    <div class="container-max">
        <div class="row align-items-center">
            ...
            <div class="col-6" >
                ...
                <form method="post" action="<?= base_url() ?>Main_control/savedata">
                ...
                <div class="d-grid gap-2 col-6 mx-auto big-submit-btn">
                    <button class="btn" type="submit" name="save" value="Register Me">Submit</button>
                </div>
                ...
                <div class="line1"></div>
                    ...
                    <a type="button" class="btn btn-link existing-acc" name="existing-account" href="<?php echo base_url('Main_control/login_page') ?>">Already have an account? <span style="color: #F1B104;">Sign in</span></a>
